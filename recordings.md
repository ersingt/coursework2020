...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | 4.01 Intro to Classification + Logistic Regression (EC \| WC) | 4.03 Classification Metrics I (EC \| WC) | 4.05 Regularization (EC \| WC) | 4.06 Hyperparameters, Gridsearch and Pipelines (EC \| WC) |  |
| Afternoon | 4.02 k-Nearest Neighbors ([EC](https://youtu.be/FhXXHCM6OAo) \| WC) | 4.04 Classification Metrics II (EC \| WC) |  |  |  |
