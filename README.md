...
|           | Day 1   | Day 2   | Day 3   | Day 4   | Day 5   |
|-----------|---------|---------|---------|---------|---------|
| Morning   | Columbus Day, No Class | [SQL I](https://git.generalassemb.ly/DSI-EAST-1/lab-sql-1) | [SQL II (lesson and lab are same repository)](https://git.generalassemb.ly/DSI-EAST-1/lab-sql-2) | [Hypothesis Testing](https://git.generalassemb.ly/DSI-EAST-1/lesson-statistics-hypothesis_testing) | Review  |
| Afternoon | Columbus Day, No Class  | [Lab](https://git.generalassemb.ly/DSI-EAST-1/lab-sql-1)     | [Lab (lesson and lab are same repository)](https://git.generalassemb.ly/DSI-EAST-1/lab-sql-2)     |  Lab    | Project | Lab 
