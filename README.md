...
|---------|------------|------------|------------|---------|---------|
| Morning | Local Time and Welcome! | [1.02 Datatypes](https://git.generalassemb.ly/DSI-US-11/1.02-lesson-python-intro) | [1.04 FUNctions](https://git.generalassemb.ly/DSI-US-11/1.04-lesson-python-functions) | 1.06 Distributions - Discrete | 1.07 List Comprehensions |
| Afternoon | [1.01 Command Line](https://git.generalassemb.ly/DSI-US-11/1.01-lesson-cli-git-global) | [1.03 Control Flow](https://git.generalassemb.ly/DSI-US-11/1.03-lesson-python-control-flow) | 1.05 Probability | Outcomes Programming | Local Time |
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | 4.01 Intro to Classification + Logistic Regression | 4.03 Classification Metrics I | 4.05 Regularization | 4.06 Hyperparameter Tuning and Pipelines | Project 2 Due |
