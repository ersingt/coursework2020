...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [Pandas: Intro 1 (Basics)](https://git.generalassemb.ly/DSI-US-4/2.01-2.02-intro-to-pandas) | Exploratory Data Analysis | SQL: Intro | Pandas: Joining DataFrames | [Project 1 Due](https://git.generalassemb.ly/DSI-US-4/project-1) |
