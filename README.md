...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [Project 3 (Reddit) / Local Time](https://git.generalassemb.ly/DSI-US-5/project-3) | [7.02 Time Series Data](https://git.generalassemb.ly/DSI-US-5/7.02-lesson-timeseries) | 7.04 Benford's Law | 7.06 Network Analysis | 7.07 Gradient Descent |
