...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [2.01 Pandas: Intro 1 (Basics)](https://git.generalassemb.ly/DSI-US-7/2.01-2.02-intro-to-pandas) | 2.03 Principles of Data Visualization | 2.04 Exploratory Data Analysis (EDA) | 2.08 Hypothesis Testing | [Project 1 Due](https://git.generalassemb.ly/DSI-US-7/project_1) |
| Afternoon | [2.02 Pandas: Intro 2 (Features and Plotting)](https://git.generalassemb.ly/DSI-US-7/2.01-2.02-intro-to-pandas) | 2.03 Principles of Data Visualization | 2.05 Central Limit Theorem and Confidence Intervals | Outcomes Programming | Local Time |
