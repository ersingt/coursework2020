...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | Project 4 (Hackathon) | [7.01 SQL I](https://git.generalassemb.ly/DSI-US-11/7.01-lesson-sql) | [7.02 Introduction to Scala](https://git.generalassemb.ly/DSI-US-11/7.02-lesson-scala) | 7.04 SparkML | 7.05 Pipelines & Cross Validation in Spark |
| Afternoon | Project 4 (Hackathon) | [7.01 SQL II](https://git.generalassemb.ly/DSI-US-11/7.01-lesson-sql) | 7.03 DataFrames in Spark | Outcomes | Guest Speaker: Joseph Nelson |
