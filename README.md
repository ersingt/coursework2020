...
https://git.generalassemb.ly/DSI-US-4/capstone
...
https://1drv.ms/u/s!AhFKW80cknnIgSUDnk3qDFrs6JzR
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [2.01 Pandas: Intro 1 (Basics)](https://git.generalassemb.ly/DSI-US-4/2.01-2.02-intro-to-pandas) | [2.03 Exploratory Data Analysis](https://git.generalassemb.ly/DSI-US-4/2.03-basic_eda_walkthrough-lesson-eda) | [2.05 SQL: Intro](https://git.generalassemb.ly/DSI-US-4/2.05-lesson-sql) | [2.07 Pandas: Joining DataFrames](https://git.generalassemb.ly/DSI-US-4/2.07-lesson-pandas-combining) | [Project 1 Due](https://git.generalassemb.ly/DSI-US-4/project-1) |
| Afternoon | [2.02 Pandas: Intro 2 (Features and Plotting)](https://git.generalassemb.ly/DSI-US-4/2.01-2.02-intro-to-pandas) | [2.04 Pandas: Advanced Transformations](https://git.generalassemb.ly/DSI-US-4/2.04-advanced-transformations-pandas) | [2.06 SQL: Joining Tables](https://git.generalassemb.ly/DSI-US-4/2.05-lesson-sql) | Outcomes: [Alumni Panel, Developing Your Network + The Local Landscape](https://git.generalassemb.ly/DSI-US-4/outcomes-dsi/blob/master/roadmap/week%2022.md) | Local Time |
| Labs | [2.01 Titanic EDA](https://git.generalassemb.ly/DSI-US-4/2.01-lab-pandas-titanic) | [2.02 Feature Engineering](https://git.generalassemb.ly/DSI-US-4/2.02-lab-pandas-feature-engineering) | | [2.03 Concatenating DataFrames](https://git.generalassemb.ly/DSI-US-4/2.03-lab-pandas-concat) | |

#### Week 3 - Regression

|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [3.01 Linear Regression: Intro](https://git.generalassemb.ly/DSI-US-4/3.01-lesson-simple_linear_regression) | [3.03 Regression Evaluation Metrics](https://git.generalassemb.ly/DSI-US-4/3.03-regression-metrics-lesson) | [3.05 Feature Engineering](https://git.generalassemb.ly/DSI-US-4/3.05-feature-engineering) | [3.07 Regularization](https://git.generalassemb.ly/DSI-US-4/3.07-lesson-regularization-regression) | [3.08 Object Oriented Programming](https://git.generalassemb.ly/DSI-US-4/3.08-lesson-object_oriented_programming-regression)  |
| Afternoon | 3.02 Linear Regression: Multivariate | [3.04 Bias-Variance Tradeoff](https://git.generalassemb.ly/DSI-US-4/3.04-bias-variance-tradeoff) | [3.06 Train/Test Split + Cross Validation](https://git.generalassemb.ly/DSI-US-4/3.06-evaluation-cross_validation_train_test-lesson) | Outcomes: [Finding Your Voice + Defining Your Brand](https://git.generalassemb.ly/DSI-US-4/outcomes-dsi/tree/master/roadmap/03-week)| Local Time |
| Labs | [3.01 Linear Regression Lab](https://git.generalassemb.ly/DSI-US-4/3.01-lab-linear_regression-regression) | | [3.02 Regularization and Validation Lab](https://git.generalassemb.ly/DSI-US-4/3.02-lab-cross_validation_regularization-regression) | | |
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [4.01 Intro to Classification + KNN](https://git.generalassemb.ly/DSI-US-4/4.01-intro-to-classification-with-knn) | [4.03 Classification Metrics I](https://git.generalassemb.ly/DSI-US-4/4.03-lesson-classification_metrics_i) | Flex Time | [4.06 Pipelines + GridSearchCV](https://git.generalassemb.ly/DSI-US-4/4.06-optimization-gridsearch_hyperparameters-lesson) | [Project 2 Due](https://git.generalassemb.ly/DSI-US-4/project-2/) |
| Afternoon | [4.02 Logistic Regression](https://git.generalassemb.ly/DSI-US-4/4.02-classification-logistic_regression-lesson) | [4.04 Classification Metrics II](https://git.generalassemb.ly/DSI-US-4/4.04-lesson-classification_metrics_ii) | [4.05 Generalized Linear Models](https://git.generalassemb.ly/DSI-US-4/4.05-generalized-linear-models) | Outcomes: [The Winning Resume Package](https://git.generalassemb.ly/DSI-US-4/outcomes-dsi/tree/master/roadmap/04-week) | Local Time |
| Labs | [4.01 Classification Model Comparison](https://git.generalassemb.ly/DSI-US-4/4.01-lab-classification_model_comparison)| [4.02 Classification Model Evaluation](https://git.generalassemb.ly/DSI-US-4/4.02-lab-classification_model_evaluation) | | | |

#### Week 5 - Web Scraping, APIs and NLP

|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [5.01 Intro to HTML](https://git.generalassemb.ly/DSI-US-4/5.01-lesson-html-css) | [5.03 Flask I](https://git.generalassemb.ly/DSI-US-4/5.03-intro-to-apis-and-flask) | [5.04 NLP I](https://git.generalassemb.ly/DSI-US-4/5.04-lesson-intro_to_nlp-nlp) | [Naive Bayes](https://git.generalassemb.ly/DSI-US-4/5.06-lesson-naive_bayes) | [5.08 Regex](https://git.generalassemb.ly/DSI-US-4/5.08-lesson-regex)  |
| Afternoon | [5.02 Web Scraping](https://git.generalassemb.ly/DSI-US-4/5.02-lesson-webscraping) | [5.03 (continued) Flask II](https://git.generalassemb.ly/DSI-US-4/5.03-intro-to-apis-and-flask) | [NLP II](https://git.generalassemb.ly/DSI-US-4/5.05-lesson-nlp_ii) | Outcomes: [A Day In The Life](https://git.generalassemb.ly/DSI-US-4/outcomes-dsi/tree/master/roadmap/05-week) | Local Time |
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | **No Class** | [6.01 CART I](https://git.generalassemb.ly/DSI-US-4/6.01-trees-CARTs-lesson) | [6.02 Bagging, Random Forests, ExtraTrees](https://git.generalassemb.ly/DSI-US-4/6.02-lesson-bagging-rfs) | [SVMs](https://git.generalassemb.ly/DSI-US-4/6.04-lesson-support_vector_machines-svm) |  [Gradient Descent](https://git.generalassemb.ly/DSI-US-4/6.05-lesson-gradient_descent) |
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [8.01 Intro to Unsupervised Learning & Topic Modeling](https://git.generalassemb.ly/DSI-US-4/8.01-lesson-intro_to_unsupervised_learning_lda) | [8.03 Hierarchical Clustering](https://git.generalassemb.ly/DSI-US-4/8.03-clustering-hierarchical_clustering-lesson) | Flex Time | [8.06 Recommender Systems](https://git.generalassemb.ly/DSI-US-4/8.06-lesson-recommender-systems) | [Project 4 Presentations](https://git.generalassemb.ly/DSI-US-4/project-4) |
| Afternoon | [8.02 K-Means Clustering](https://git.generalassemb.ly/DSI-US-4/8.02-clustering-intro_to_clustering_kmeans-lesson) | [8.04 DBSCAN and HDBSCAN Clustering](https://git.generalassemb.ly/DSI-US-4/8.04-lesson-dbscan_hdbscan) | [8.05 Principal Component Analysis](https://git.generalassemb.ly/DSI-US-4/8.05-lesson-pca-intro-pca) | Outcomes | Local Time |
| Labs | [(Optional) 8.02 Plutonium K-Means](https://git.generalassemb.ly/DSI-US-4/8.02-clustering-intro_to_clustering_kmeans-lesson/blob/master/lab-kmeans-isotopes.ipynb) | [8.04 Battle Of The Clusterers Lab](https://git.generalassemb.ly/DSI-US-4/8.04-clustering-battle_of_clusterers-lab) | [8.05 PCA Lab](https://git.generalassemb.ly/DSI-US-4/8.05-pca-intro-lab) | | |
...
| Labs | |[10.04 Timeseries: ARIMA lab ](https://git.generalassemb.ly/DSI-US-4/10.04-timeseries-arima-lab) | | [10.07 Spatial Lab](https://git.generalassemb.ly/DSI-US-4/10.07-spatial-lab) | |

#### Week 11 - Big Data

|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [11.01 AWS + Docker](https://git.generalassemb.ly/DSI-US-4/11.01-docker-on-aws) | [11.03 Spark DataFrames](https://git.generalassemb.ly/DSI-US-4/11.03-lesson-dataframes) | NO CLASS | Machine Learning with Spark | Pipelines and Cross Validation with Spark |
| Afternoon | [11.02 Intro to Scala](https://git.generalassemb.ly/DSI-US-4/11.02-lesson-scala) | Ethics and Model Explainability | NO CLASS | Outcomes | Flex |
