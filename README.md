...
----- | ----- | ------ | ---- | ----- | ---- |
**9:00am <br> 9:45am** | Morning Exercise | Morning Exercise | Morning Exercise | Morning Exercise | Morning Exercise 
**10:00am <br> 1:00pm** | [Logistic Regression](https://git.generalassemb.ly/DSI-ATX-2/lesson-logistic-regression) | [SVM](https://git.generalassemb.ly/DSI-ATX-2/lesson-svm), [SVM Lab](https://git.generalassemb.ly/DSI-ATX-2/lab-svm) | Introduction to HTML/CSS Scraping | Web Scraping I | Project 4
