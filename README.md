...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [11.01 AWS + Docker](https://git.generalassemb.ly/DSI-US-4/11.01-docker-on-aws) | DataFrames with Spark | NO CLASS | Spark in the Cloud | Machine Learning with Spark |
