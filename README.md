...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [4.01 Intro to Classification + Logistic Regression](https://git.generalassemb.ly/DSI-US-8/4.01-lesson-logistic_regression) | [4.03 Classification Metrics I](https://git.generalassemb.ly/DSI-US-8/4.03-lesson-classification_metrics_i) | 4.05 Hyperparameter Tuning and Pipelines | Project Work Time | Project 2 Due |
