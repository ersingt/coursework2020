...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [11.01 SQL I](https://git.generalassemb.ly/DSI-US-7/11.01-lesson-sql) | 11.03 Introduction to Scala | 11.05 Classification & Regression in Spark | 11.07 Docker on AWS | Project Worktime |
