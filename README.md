...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [Local Project/Hackathon](https://git.generalassemb.ly/DSI-US-8/Hackathon-Good-Fast-Cheap) | 7.01 SQL I | 7.03 Introduction to Scala | 7.05 Classification & Regression in Spark | 7.06 Pipelines & GridSearch in Spark |
| Afternoon | [Local Project/Hackathon](https://git.generalassemb.ly/DSI-US-8/Hackathon-Good-Fast-Cheap) | 7.02 SQL II | 7.04 DataFrames in Spark | Outcomes | Local Time |
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | 8.01 Intro to Clustering: K-Means | 8.03 Transfer Learning | 8.05 Recommender Systems | 8.06 Missing Data | 8.07 Word Vectors |
| Afternoon | 8.02 DBSCAN Clustering | 8.04 PCA | Project Worktime | Outcomes | Local Time |
