...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [Plotting](https://git.generalassemb.ly/DSI-WEST-3/lesson-matplotlib) ([Lab](https://git.generalassemb.ly/DSI-WEST-3/lab-matplotlib)) | [SQL I](https://git.generalassemb.ly/DSI-WEST-3/lesson-sql) | [SQL II](https://git.generalassemb.ly/DSI-WEST-3/lesson-sql) | Stats: Discrete + Continuous Distributions (Lab) | [Titanic EDA Lab](https://git.generalassemb.ly/DSI-WEST-3/project-pandas-titanic)  |
