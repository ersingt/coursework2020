...
| Labs | [1.01 Pokemon Lab](https://git.generalassemb.ly/DSI-US-5/1.01-lab-pokemon) | | 1.02 Distributions Lab | | |
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | 3.01 Linear Regression: Intro | 3.03 Regression Evaluation Metrics | 3.05 Feature Engineering | 3.07 Regularization | 3.08 Object Oriented Programming  |
| Afternoon | 3.02 Linear Regression: Multivariate | 3.04 Bias-Variance Tradeoff | 3.06 Train/Test Split + Cross Validation | Outcomes: Finding Your Voice + Defining Your Brand| Local Time |
...
| Afternoon | 4.02 Logistic Regression | 4.04 Classification Metrics II | 4.05 Generalized Linear Models | Outcomes: The Winning Resume Package | Local Time |
...
| Afternoon | 5.02 Web Scraping | 5.03 (continued) Flask II | NLP II | Outcomes: A Day In The Life | Local Time |
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | **No Class** | 6.01 CART I | 6.02 Bagging, Random Forests, ExtraTrees | SVMs |  Gradient Descent |
| Afternoon | **No Class** | 6.01 CART II | 6.03 Boosting | Outcomes: GA Profiles, Blogging + Portfolios | Local Time |
...
| Afternoon | Flex/Hackathon | 7.02 Intro to Keras | 7.04 CNNs I | Outcomes: Guest Speaker, Catch Your Breath + Regroup | Local Time |
...
| Afternoon | 8.02 K-Means Clustering | 8.04 DBSCAN and HDBSCAN Clustering | 8.05 Principal Component Analysis | Outcomes | Local Time |
...
| Afternoon | 9.02 Intro to Bayes | 9.04 Maximum Likelihood Estimation | Project Worktime | Outcomes | Local Time |
...
| Afternoon | 10.02 Time Series Data | 10.04 ARIMA | 10.06 Benford's Law | Outcomes | Flex/Hackathon |
...
| Afternoon | 11.02 Intro to Scala | Ethics and Model Explainability | NO CLASS | Outcomes: Technical Interview Prep | Flex |
...
| Afternoon | Capstone | Capstone | Capstone | Outcomes: Qualification Check In + Post-Course Expectations| Local Flex | 
