...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [8.01 Intro to Clustering: K-Means](https://git.generalassemb.ly/DSI-US-8/8.01-lesson-intro-to-kmeans) | 8.03 PCA | 8.05 Recommender Systems | 8.06 Missing Data | 8.07 Word Vectors |
| Afternoon | [8.02 DBSCAN Clustering](https://git.generalassemb.ly/DSI-US-8/8.02-lesson-dbscan) | 8.04 Transfer Learning | Project Worktime | Outcomes | Local Time |
| Labs      | [8.01 Clustering Lab](https://git.generalassemb.ly/DSI-US-8/8.01-lab-kmeans-isotopes) | 8.02 PCA Lab |  |  |  |
