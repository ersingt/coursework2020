...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [4.01 Intro to Classification + Logistic Regression](https://git.generalassemb.ly/DSI-US-6/classification-logistic_regression-lesson) | [4.03 Classification Metrics I](https://git.generalassemb.ly/DSI-US-6/4.03-lesson-classification_metrics_i) | [4.05 Hyperparameter Tuning and Pipelines](https://git.generalassemb.ly/DSI-US-6/4.05-optimization-gridsearch_hyperparameters-lesson) | 4.06 API Integration & Consumption | [Project 2 Due](https://git.generalassemb.ly/DSI-US-6/project-2) |
| Afternoon | [4.02 k-Nearest Neighbors](https://git.generalassemb.ly/DSI-US-6/4.02-lesson-knn) | [4.04 Classification Metrics II](https://git.generalassemb.ly/DSI-US-6/4.04-lesson-classification_metrics_ii) | Project Worktime | Local Time | Outcomes Programming |
