...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [10.01 Introduction to Neural Networks](https://git.generalassemb.ly/DSI-US-5/10.01-lesson-keras) | 10.03 Deep Learning Regularization Methods | 10.05 Convolutional Neural Networks II | 10.07 Introduction to TensorFlow | Local Time |
