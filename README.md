...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [Plotting](https://git.generalassemb.ly/DSI-WEST-3/lesson-matplotlib) ([Lab](https://git.generalassemb.ly/DSI-WEST-3/lab-matplotlib)) | Stats: Discrete + Continuous Distributions (Lab) | SQL I | SQL II | [Titanic EDA Lab](https://git.generalassemb.ly/DSI-WEST-3/project-pandas-titanic)  |
