...
https://www.youtube.com/playlist?list=PLYGvOQTnahYL12cyVk2cLun_SWG-bKd6j
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [2.01 Pandas: Intro 1 (Basics)](https://git.generalassemb.ly/DSI-US-8/2.01-2.02-intro-to-pandas) | [2.03 Principles of Data Visualization](https://git.generalassemb.ly/DSI-US-8/2.03-lesson-principles_of_data_visualization) | [2.04 Exploratory Data Analysis (EDA)](https://git.generalassemb.ly/DSI-US-8/2.04-lesson-eda) | [2.06 Hypothesis Testing](https://git.generalassemb.ly/DSI-US-8/2.06-lesson-hypothesis-testing) | [Project 1 Due](https://git.generalassemb.ly/DSI-US-8/project_1) |
| Afternoon | [2.02 Pandas: Intro 2 (Features)](https://git.generalassemb.ly/DSI-US-8/2.01-2.02-intro-to-pandas) | [2.03 Principles of Data Visualization](https://git.generalassemb.ly/DSI-US-8/2.03-lesson-principles_of_data_visualization) | [2.05 Central Limit Theorem and Confidence Intervals](https://git.generalassemb.ly/DSI-US-8/2.05-lesson-statistical_inference_confidence_intervals) | Outcomes Programming | Local Time |
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [3.01 Linear Regression](https://git.generalassemb.ly/DSI-US-8/3.01-lesson-linear-regression) | [3.02 Regression Evaluation Metrics](https://git.generalassemb.ly/DSI-US-8/3.02-regression-metrics-lesson) | [3.04 Train/Test Split + Cross Validation](https://git.generalassemb.ly/DSI-US-8/3.04-lesson-cross-validation-train-test-split) | [3.06 Regularization](https://git.generalassemb.ly/DSI-US-8/3.06-regularization) | [3.07 Model Workflow](https://git.generalassemb.ly/DSI-US-8/3.07-lesson-model-workflow) |
| Afternoon | [3.01 Linear Regression](https://git.generalassemb.ly/DSI-US-8/3.01-lesson-linear-regression) | [3.03 Bias-Variance Tradeoff](https://git.generalassemb.ly/DSI-US-8/3.03-bias-variance-tradeoff) | [3.05 Feature Engineering](https://git.generalassemb.ly/DSI-US-8/3.05-lesson-feature-engineering) | Outcomes Programming | Local Time |
| Labs | [3.01 Linear Regression Lab](https://git.generalassemb.ly/DSI-US-8/3.01-lab-linear_regression-regression) | | |  | |
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [4.01 Intro to Classification + Logistic Regression](https://git.generalassemb.ly/DSI-US-8/4.01-lesson-logistic_regression) | [4.03 Classification Metrics I](https://git.generalassemb.ly/DSI-US-8/4.03-lesson-classification_metrics_i) | [4.05 Hyperparameter Tuning and Pipelines](https://git.generalassemb.ly/DSI-US-8/4.05-lesson-gridsearch-and-pipelines) | [4.06 API Integration & Consumption](https://git.generalassemb.ly/DSI-US-8/4.06-lesson-apis) | Project 2 Due |
| Afternoon | [4.02 k-Nearest Neighbors](https://git.generalassemb.ly/DSI-US-8/4.02-lesson-knn) | [4.04 Classification Metrics II](https://git.generalassemb.ly/DSI-US-8/4.04-lesson-classification_metrics_ii) | Project Worktime | Outcomes Programming | Local Time |
| Labs | [4.01 Classification Model Comparison](https://git.generalassemb.ly/DSI-US-8/4.01-lab-classification_model_comparison) | [4.02 Classification Model Evaluation](https://git.generalassemb.ly/DSI-US-8/4.02-lab-classification_model_evaluation) | | | |
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [5.01 Intro to HTML](https://git.generalassemb.ly/DSI-US-8/5.01-lesson-html-css) | [5.03 NLP I](https://git.generalassemb.ly/DSI-US-8/5.03-lesson-nlp_i) | [5.05 Object-Oriented Programming](https://git.generalassemb.ly/DSI-US-8/5.05-lesson-object-oriented-programming) | No Class | No Class |
| Afternoon | [5.02 BeautifulSoup](https://git.generalassemb.ly/DSI-US-8/5.02-lesson-webscraping) | [5.04 NLP II](https://git.generalassemb.ly/DSI-US-8/5.04-lesson-nlp_ii) | [5.06 Introduction to AWS](https://git.generalassemb.ly/DSI-US-8/5.06-lesson-intro-to-aws) | No Class | No Class |
| Labs | [5.01 Scraping Lab](https://git.generalassemb.ly/DSI-US-8/5.01-lab-beautiful_soup-webscraping) | [5.02 NLP Lab](https://git.generalassemb.ly/DSI-US-8/5.02-lab-nlp-naive-bayes) |  | | |
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [6.01 CART](https://git.generalassemb.ly/DSI-US-8/6.01-lesson-decision_trees) | [6.03 Random Forests and Extra Trees](https://git.generalassemb.ly/DSI-US-8/6.03-lesson-random-forests) | [6.05 SVMs](https://git.generalassemb.ly/DSI-US-8/6.05-lesson-support_vector_machines) | [6.07 Gradient Descent](https://git.generalassemb.ly/DSI-US-8/6.07-lesson-gradient-descent) | [Project 3](https://git.generalassemb.ly/DSI-US-8/project_3) |
| Afternoon | [6.02 Bootstrapping and Bagging](https://git.generalassemb.ly/DSI-US-8/6.02-lesson-bagging) | [6.04 Boosting](https://git.generalassemb.ly/DSI-US-8/6.04-lesson-boosting) | [6.06 GLMs](https://git.generalassemb.ly/DSI-US-8/6.06-lesson-generalized_linear_models) | Outcomes Programming | Local Time |
| Labs | [6.01 Supervised Model Comparison](https://git.generalassemb.ly/DSI-US-8/6.01-lab-supervised_learning_models) | | | |
| Deadlines | Week 5 Labs |  | Blog Post 3 |  | [Project 3 Presentation](https://git.generalassemb.ly/DSI-US-8/project_3) |

#### Week 7 - Big Data & Data Engineering (July 15 - July 19)
...
#### Week 9 - Correlated Data (July 29 - August 2)
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [10.01 Intro to Bayes](https://git.generalassemb.ly/DSI-US-8/10.01-lesson-intro-to-bayes) | [10.03 PyMC & Bayesian Regression](https://git.generalassemb.ly/DSI-US-8/10.03-lesson-pymc-bayesian-regression) | [10.05 MCMC](https://git.generalassemb.ly/DSI-US-8/10.05-lesson-mcmc) | [10.06 Experimental Design](https://git.generalassemb.ly/DSI-US-8/10.06-10.07-lesson-experimental-design) | [10.07 A/B Testing](https://git.generalassemb.ly/DSI-US-8/10.06-10.07-lesson-experimental-design) |
| Afternoon | [10.02 Bayesian Inference](https://git.generalassemb.ly/DSI-US-8/10.02-lesson-bayesian_inference) | [10.04 Conjugacy, Maximum Likelihood](https://git.generalassemb.ly/DSI-US-8/10.04-lesson-bayes-conjugacy-mle) | Project Work Time | Outcomes | Local Time |
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [11.01 Introduction to Neural Networks](https://git.generalassemb.ly/DSI-US-8/11.01-lesson-intro-to-neural-networks) | [11.03 Deep Learning Regularization](https://git.generalassemb.ly/DSI-US-8/11.03-lesson-regularizing-optimizing-nn) | [11.05 Recurrent Neural Networks](https://git.generalassemb.ly/DSI-US-8/11.05-lesson-rnn) | [11.06 Introduction to TensorFlow](https://git.generalassemb.ly/DSI-US-8/11.06-lesson-tensorflow) | Local Time |
| Afternoon | [11.02 Introduction to Keras](https://git.generalassemb.ly/DSI-US-8/11.02-lesson-keras) | [11.04 Convolutional Neural Networks](https://git.generalassemb.ly/DSI-US-8/11.04-lesson-cnn) |  | [Outcomes: Technical Interview Prep](https://git.generalassemb.ly/DSI-US-8/outcomes-tech-interview-prep) | Local Time |
...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [12.01 The Linux Environment & Shell Scripting](https://git.generalassemb.ly/DSI-US-8/12.01-linux-and-automation) | [12.02 Flask](https://git.generalassemb.ly/DSI-US-8/12.02-lesson-flask-basics) | Local Flex Time | Local Flex Time | Local Flex Time |
