...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [4.01 Intro to Classification + Logistic Regression](https://git.generalassemb.ly/DSI-US-10/4.01-lesson-logistic-regression) | [4.03 Classification Metrics I](https://git.generalassemb.ly/DSI-US-10/4.03-lesson-classification_metrics_i) | 4.05 Regularization | 4.06 Hyperparameter Tuning and Pipelines | [Project 2 Due](https://git.generalassemb.ly/DSI-US-10/project_2) |
