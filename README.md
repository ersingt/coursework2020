...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [3.01 Linear Regression](https://git.generalassemb.ly/DSI-US-7/3.01-lesson-linear_regression) | 3.02 Regression Evaluation Metrics | 3.04 Train/Test Split + Cross Validation | 3.06 Regularization | 3.07 Model Workflow |
