...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [11.01 AWS + Docker](https://git.generalassemb.ly/DSI-US-4/11.01-docker-on-aws) | [11.03 Spark DataFrames](https://git.generalassemb.ly/DSI-US-4/11.03-lesson-dataframes) | NO CLASS | Spark in the Cloud | Machine Learning with Spark |
