...
|           | Monday        | Tuesday       | Wednesday     | Thursday      | Friday  |
|-----------|---------------|---------------|---------------|---------------|---------|
| Morning   | [Web Scraping I](https://git.generalassemb.ly/DSI-WEST-3/python-intro_to_webscraping-lesson) ([Lab](https://git.generalassemb.ly/DSI-WEST-3/lab-beautiful-soup)) | [APIs: Flask](https://git.generalassemb.ly/DSI-WEST-3/flask-docker) | NLP I ([Lab](https://git.generalassemb.ly/DSI-WEST-3/nlp-intro_to_nlp-lab)) | [Regex](https://git.generalassemb.ly/DSI-WEST-3/python-regex-lesson/) ([Lab](https://git.generalassemb.ly/DSI-WEST-3/lab-regex)) | Review  |
